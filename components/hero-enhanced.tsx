            ...
            >
               <span className="relative z-10 flex items-center gap-3 sm:gap-4">
                 {ising ? 
                   ...
                   <><FaDownload className="text-lg sm:text-xl" /> <span className="hidden xs:inline text-base sm:text-lg">Download Resume</span><span className="xs:hidden text-sm">Resume</span></>
                 }
               </span>
            </motion.button>
